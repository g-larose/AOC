...
namespace _2023.Day6.Benchmark;
[MemoryDiagnoser]
public class Benchmark_Day6 : Solution
{
    public Benchmark_Day6() : base(2023, 6)
    {
    ...
    public long PartTwo()
    {
        ...
        var race = new Day6.Race(time, distance);
        var boat = new Day6.Boat();
    ...
    public class Boat
    {
        ...
        public (long time, long traveled) Finish(Day6.Race race)
        {
            long time = race.Time;
